...
function create_sou_prog(Request $request)
{
    ...
    $request->validate([
        ...
        'T1_AE_init' => 'required|numeric',
        'T1_CP_init' => 'required|numeric',

        'T2_AE_init' => 'required|numeric',
        'T2_CP_init' => 'required|numeric',

        'T3_AE_init' => 'required|numeric',
        'T3_CP_init' => 'required|numeric',

        'T4_AE_init' => 'required|numeric',
        'T4_CP_init' => 'required|numeric',
    ]);
   // dd($request);

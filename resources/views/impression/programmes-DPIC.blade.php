                ...
                <tbody>
                    ...
                    @for($j = 0; $j < count($programme['sous_programmes']); $j++)
                        @foreach ($programme['sous_programmes'][$j] as $sousProgramme)
                            ...
                            @if(isset($sousProgramme['actions'][0]))
                                @php
                                $nbract=count($sousProgramme['actions'])-1;
                                @endphp
                            ...
                            <tr class="ttaction-title">
                                ...
                                @php
                               // dd($programme['sous_programmes'][$j]['sous_programmes']['Total']);
                                @endphp
                                
                                @if( !empty($programme['sous_programmes']))
                              
                                    <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][$j]['sous_programmes']['Total']['TotalT1_AE'], 2, '.', ',') }}</td>
                                    <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][$j]['sous_programmes']['Total']['TotalT1_CP'], 2, '.', ',') }}</td>
                                    <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][$j]['sous_programmes']['Total']['TotalT2_AE'], 2, '.', ',') }}</td>
                                    <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][$j]['sous_programmes']['Total']['TotalT2_CP'], 2, '.', ',') }}</td>
                                    <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][$j]['sous_programmes']['Total']['TotalT3_AE'], 2, '.', ',') }}</td>
                                    <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][$j]['sous_programmes']['Total']['TotalT3_CP'], 2, '.', ',') }}</td>
                                    <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][$j]['sous_programmes']['Total']['TotalT4_AE'], 2, '.', ',') }}</td>
                                    <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][$j]['sous_programmes']['Total']['TotalT4_CP'], 2, '.', ',') }}</td>
                                    @php
                                    $chang=false;
                                    @endphp
                                @else
                            ...
                            @if(isset($sousProgramme['actions'][0]))
                                ...
                                <tr class="ttaction-title">
                                    ...
                                    @if(isset($action))
                                        ...
                                        <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][0]['sous_programmes']['Total']['TotalT1_AE'], 2, '.', ',') }}</td>
                                        <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][0]['sous_programmes']['Total']['TotalT1_CP'], 2, '.', ',') }}</td>
                                        <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][0]['sous_programmes']['Total']['TotalT2_AE'], 2, '.', ',') }}</td>
                                        <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][0]['sous_programmes']['Total']['TotalT2_CP'], 2, '.', ',') }}</td>
                                        <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][0]['sous_programmes']['Total']['TotalT3_AE'], 2, '.', ',') }}</td>
                                        <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][0]['sous_programmes']['Total']['TotalT3_CP'], 2, '.', ',') }}</td>
                                        <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][0]['sous_programmes']['Total']['TotalT4_AE'], 2, '.', ',') }}</td>
                                        <td  class="ttaction-title">{{ number_format((float)$programme['sous_programmes'][0]['sous_programmes']['Total']['TotalT4_CP'], 2, '.', ',') }}</td>
                                    @php

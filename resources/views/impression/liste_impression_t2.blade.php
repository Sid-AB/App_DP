...
<table class="first-table">
    <thead>
        ...
        <tr>
            ...
            <td style="text-align: center; "> {{ number_format((float)$resultstructur['centrale']['T2']['total'][0]['values']['totalAE'], 2, '.', ',') ?? 'N/A' }}</td>
            <td style="text-align: center; ">{{ number_format((float)$resultstructur['centrale']['T2']['total'][0]['values']['totalCP'], 2, '.', ',') ?? 'N/A' }}</td>
        </tr>
    </thead>
...
<table>
        ...
        <tbody>
        @if(!empty($resultstructur['centrale']['T2']['groupedData']))
                @foreach ($resultstructur['centrale']['T2']['groupedData'] as $groupData)
                @php
                ...
                <td style="text-align: center; ">{{ number_format((float)$groupData['group']['values']['ae_ouvert'], 2, '.', ',') ?? 'N/A' }}</td>
                <td style="text-align: center; ">{{ number_format((float)$groupData['group']['values']['cp_ouvert'], 2, '.', ',') ?? 'N/A' }}</td>

                <td style="text-align: center; ">{{ number_format((float)$groupData['group']['values']['ae_attendu'], 2, '.', ',') ?? 'N/A' }}</td>
                <td style="text-align: center; ">{{ number_format((float)$groupData['group']['values']['cp_attendu'], 2, '.', ',') ?? 'N/A' }}</td>

                <td style="text-align: center; ">{{ number_format((float)$groupData['group']['values']['total_ae'], 2, '.', ',') ?? 'N/A' }}</td>
                <td style="text-align: center; ">{{ number_format((float)$groupData['group']['values']['total_cp'], 2, '.', ',') ?? 'N/A' }}</td>
            </tr>
                ...
                <td style="text-align: center; ">{{ number_format((float)$operationData['operation']['values']['ae_ouvert'], 2, '.', ',') ?? 'N/A' }}</td>
                <td style="text-align: center; ">{{ number_format((float)$operationData['operation']['values']['cp_ouvert'], 2, '.', ',') ?? 'N/A' }}</td>

                <td style="text-align: center; ">{{ number_format((float)$operationData['operation']['values']['ae_attendu'], 2, '.', ',') ?? 'N/A' }}</td>
                <td style="text-align: center; ">{{ number_format((float)$operationData['operation']['values']['cp_attendu'], 2, '.', ',') ?? 'N/A' }}</td>

                <td style="text-align: center; ">{{ number_format((float)$operationData['operation']['values']['total_ae'], 2, '.', ',') ?? 'N/A' }}</td>
                <td style="text-align: center; ">{{ number_format((float)$operationData['operation']['values']['total_cp'], 2, '.', ',') ?? 'N/A' }}</td>
            ...
            @php
                ...
                <tr>
                    ...
                    <td style="text-align: center; ">{{ number_format((float)$sousOp['values']['ae_ouvert'], 2, '.', ',') ?? 'N/A' }}</td>
                    <td style="text-align: center; ">{{ number_format((float)$sousOp['values']['cp_ouvert'], 2, '.', ',') ?? 'N/A' }}</td>

                    <td style="text-align: center; ">{{ number_format((float)$sousOp['values']['ae_attendu'], 2, '.', ',') ?? 'N/A' }}</td>
                    <td style="text-align: center; ">{{ number_format((float)$sousOp['values']['cp_attendu'], 2, '.', ',') ?? 'N/A' }}</td>

                    <td style="text-align: center; "> {{ number_format((float)$sousOp['values']['total_ae'], 2, '.', ',') ?? 'N/A' }}</td>
                    <td style="text-align: center; ">{{ number_format((float)$sousOp['values']['total_cp'], 2, '.', ',') ?? 'N/A' }}</td>
                </tr>
                @endif
            @endforeach
        @endforeach
    ...
    @if(!empty($resultstructur['centrale']['T2']['groupedData']))
        <tr class="total2">
            ...
            <td style="text-align: center;">{{ number_format((float)$resultstructur['centrale']['T2']['total'][0]['values']['totalAEouvrtvertical'], 2, '.', ',') ?? 'N/A' }}</td>
            <td style="text-align: center;">{{ number_format((float)$resultstructur['centrale']['T2']['total'][0]['values']['totalCPouvrtvertical'], 2, '.', ',') ?? 'N/A' }}</td>
            <td style="text-align: center;">{{ number_format((float)$resultstructur['centrale']['T2']['total'][0]['values']['totalAEattenduvertical'], 2, '.', ',') ?? 'N/A' }}</td>
            <td style="text-align: center;">{{ number_format((float)$resultstructur['centrale']['T2']['total'][0]['values']['totalCPattenduvertical'], 2, '.', ',') ?? 'N/A' }}</td>
            <td style="text-align: center;">{{ number_format((float)$resultstructur['centrale']['T2']['total'][0]['values']['totalAE'], 2, '.', ',') ?? 'N/A' }}</td>
            <td style="text-align: center;">{{ number_format((float)$resultstructur['centrale']['T2']['total'][0]['values']['totalCP'], 2, '.', ',') ?? 'N/A' }}</td>
        </tr>

                                             ...
                                             $.ajax({
                                                 ...
                                                 success: function (response) {
                                                     if (response.code == 200 || response.code == 404) {
                                                         ...
                                                         //verifi l action si elle existe
                                                         $('#date_insert_action').on('click',function(){
                                                                ...
                                                                if (userResponse) {
                                                                    ...
                                                                    var date_insert_action = $(this).val(); // Récupérer la valeur du programme
                                                                    var num_action = $('#num_act').val(); // Récupérer la valeur de la date du programme
                                                                    var id_sou_prog = path[2];
                                                                    var num_act = num_action + id_sou_prog; // Composer num_program
